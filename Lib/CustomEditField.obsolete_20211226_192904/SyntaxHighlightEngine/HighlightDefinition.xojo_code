...
Protected Class HighlightDefinition
	...
	#tag Constant, Name = DosBoxDef, Type = String, Dynamic = False, Default = \"<\?xml version\x3D\"1.0\" encoding\x3D\"UTF-8\"\?>\n<highlightDefinition version\x3D\"1.4\">\n\t<name>DOSBox</name>\n\t<blockStartMarker indent\x3D\"1\">\\s*\\[\\s*$</blockStartMarker>\n\t<blockEndMarker>^\\s*\\]</blockEndMarker>\n\t<symbols>\n\t</symbols>\n\t<contexts defaultColor\x3D\"#000000\" caseSensitive\x3D\"yes\">\n\t\t<highlightContext name\x3D\"Characters\" highlightColor\x3D\"#0000FF\">\n\t\t\t<startRegEx>\'</startRegEx>\n\t\t\t<endRegEx>(\\\\\'\')|(.\')</endRegEx>\n\t\t</highlightContext>\n\t\t<highlightContext name\x3D\"Comment\" highlightColor\x3D\"#417F25\">\n\t\t\t<startRegEx>#</startRegEx>\n\t\t\t<endRegEx>[\\n\\r]</endRegEx>\n\t\t</highlightContext>\n\t\t<highlightContext name\x3D\"SingleComment\" highlightColor\x3D\"#236E25\">\n\t\t\t<startRegEx>#</startRegEx>\n\t\t\t<endRegEx>[\\n\\r]</endRegEx>\n\t\t</highlightContext>\n\t\t<highlightContext name\x3D\"String\" highlightColor\x3D\"#760F15\">\n\t\t\t<startRegEx>\"</startRegEx>\n\t\t\t<endRegEx>(((\?&lt;!\\\\)(\\\\\\\\)*)|^)\"</endRegEx>\n\t\t</highlightContext>\n\t\t<highlightContext name\x3D\"square-bracket-command\" highlightColor\x3D\"#FF8000\" bold\x3D\"true\">\n\t\t\t<startRegEx>\\[:</startRegEx>\n\t\t\t<endRegEx>\\]</endRegEx>\n\t\t</highlightContext>\n\t\t<highlightContext name\x3D\"section\" highlightColor\x3D\"#1F187F\" bold\x3D\"true\">\n\t\t\t<keywords>\n\t\t\t\t<string>sdl</string>\n\t\t\t\t<string>dosbox</string>\n\t\t\t\t<string>render</string>\n\t\t\t\t<string>cpu</string>\n\t\t\t\t<string>mixer</string>\n\t\t\t\t<string>midi</string>\n\t\t\t\t<string>sblaster</string>\n\t\t\t\t<string>gus</string>\n\t\t\t\t<string>speaker</string>\n\t\t\t\t<string>joystick</string>\n\t\t\t\t<string>serial</string>\n\t\t\t\t<string>dos</string>\n\t\t\t\t<string>ipx</string>\n\t\t\t\t<string>autoexec</string>\n\t\t\t</keywords>\n\t\t</highlightContext>\n\t\t<highlightContext name\x3D\"Keywords\" highlightColor\x3D\"#881350\">\n\t\t\t<keywords>\n\t\t\t\t<string>fullscreen</string>\n\t\t\t\t<string>fulldouble</string>\n\t\t\t\t<string>fullresolution</string>\n\t\t\t\t<string>windowresolution</string>\n\t\t\t\t<string>output</string>\n\t\t\t\t<string>autolock</string>\n\t\t\t\t<string>sensitivity</string>\n\t\t\t\t<string>waitonerror</string>\n\t\t\t\t<string>priority</string>\n\t\t\t\t<string>mapperfile</string>\n\t\t\t\t<string>usescancodes</string>\n\t\t\t\t<string>language</string>\n\t\t\t\t<string>memsize</string>\n\t\t\t\t<string>machine</string>\n\t\t\t\t<string>captures</string>\n\t\t\t\t<string>frameskip</string>\n\t\t\t\t<string>aspect</string>\n\t\t\t\t<string>scaler</string>\n\t\t\t\t<string>core</string>\n\t\t\t\t<string>cputype</string>\n\t\t\t\t<string>cycles</string>\n\t\t\t\t<string>cycleup</string>\n\t\t\t\t<string>cycledown</string>\n\t\t\t\t<string>mpu401</string>\n\t\t\t\t<string>mididevice</string>\n\t\t\t\t<string>midiconfig</string>\n\t\t\t\t<string>serialX</string>\n\t\t\t\t<string>xms</string>\n\t\t\t\t<string>ems</string>\n\t\t\t\t<string>umb</string>\n\t\t\t\t<string>keyboardlayout</string>\n\t\t\t\t<string>ipx</string>\n\t\t\t\t<string>static</string>\n\t\t\t\t<string>auto</string>\n\t\t\t\t<string>register</string>\n\t\t\t\t<string>short</string>\n\t\t\t\t<string>volatile</string>\n\t\t\t\t<string>class</string>\n\t\t\t\t<string>public</string>\n\t\t\t\t<string>protected</string>\n\t\t\t\t<string>private</string>\n\t\t\t\t<string>this</string>\n\t\t\t</keywords>\n\t\t</highlightContext>\n\t\t<highlightContext name\x3D\"Numbers\" highlightColor\x3D\"#0000FF\">\n\t\t\t<entryRegEx>(\?&lt;\x3D[^\\w\\d]|^)(((([0-9]+\\.[0-9]*)|(\\.[0-9]+))([eE][+\\-]\?[0-9]+)\?[fFlL]\?)|((([1-9][0-9]*)|0[0-7]*|(0[xX][0-9a-fA-F]+))(([uU][lL]\?)|([lL][uU]\?))\?))(\?\x3D[^\\w\\d]|$)</entryRegEx>\n\t\t</highlightContext>\n\t</contexts>\n</highlightDefinition>", Scope = Public
	#tag EndConstant
