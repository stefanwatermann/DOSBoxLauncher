...
Begin Window FindWindow
   ...
   Begin PushButton btnReplaceAll
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Tooltip         =   "Replace all occurrences of the find text"
      Top             =   114
      Transparent     =   True
      Underline       =   False
      Visible         =   True
   ...
   Begin PushButton btnReplace
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Tooltip         =   "Replace selected text with the replacement text"
      Top             =   114
      Transparent     =   True
      Underline       =   False
      Visible         =   True
   ...
   Begin PushButton btnReplaceAndFind
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Tooltip         =   "Replace selected text and find next occurrence of the find text"
      Top             =   114
      Transparent     =   True
      Underline       =   False
      Visible         =   True
   ...
   Begin PushButton btnNext
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Tooltip         =   "find next occurrence of the find text"
      Top             =   114
      Transparent     =   True
      Underline       =   False
      Visible         =   True
